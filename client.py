...
class FluidEnv(gym.Env):
    ...
    def __init__(self, config: EnvContext):
        ...
        self.observation_space = gym.spaces.Box(low=-5.0, high=5.0, shape=obs_shape, dtype=np.float16)
        self.action_space = gym.spaces.Box(low=-1.0, high=0.0, shape=(nx*ny,), dtype = np.float16)
